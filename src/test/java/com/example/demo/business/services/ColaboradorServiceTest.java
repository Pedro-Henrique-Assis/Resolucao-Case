...
class ColaboradorServiceTest {
    ...
    class consultarColaboradorPorMatricula {
        ...
        void deveConsultarColaboradorPorMatriculaQuandoTemAvaliacaoMasNaoTemEntregas() {
            ...
            Colaborador colaboradorEncontrado = new Colaborador(matriculaUUID, "Colaborador Com Avaliacao", LocalDate.now(), "Analista");

            AvaliacaoComportamento avaliacaoEncontrada = new AvaliacaoComportamento();
            ...
            colaboradorEncontrado.setAvaliacaoComportamento(avaliacaoEncontrada);
            colaboradorEncontrado.setEntregas(Collections.emptyList());
            ...
            // Extrai o objeto ColaboradorRespostaDTO do resultado retornado
            ColaboradorRespostaDTO dto = resultado.get();
        ...
        void deveConsultarColaboradorPorMatriculaQuandoTemEntregasMasNaoTemAvaliacao() {
            ...
            var colaboradorEncontrado = new Colaborador(matriculaUUID, "Colaborador Com Entregas", LocalDate.now(), "Engenheiro");
    ...
    class listarColaboradores {
        ...
        void deveRetornarListaVaziaQuandoRepositorioVazio() {
            ...
            List<ColaboradorRespostaDTO> resultado = colaboradorService.listarColaboradores();
        ...
        void deveListarCorretamenteColaboradoresCombinacoesDeDados() {
            ...
            Colaborador c1 = new Colaborador(m1, "Alice", LocalDate.of(2024, 1, 1), "Engenheira");
            AvaliacaoComportamento av1 = new AvaliacaoComportamento();
            ...
            Colaborador c2 = new Colaborador(m2, "Bruno", LocalDate.of(2024, 2, 2), "Analista");
            c2.setAvaliacaoComportamento(null);
            Entrega e21 = new Entrega();
            e21.setId(101L);
            e21.setDescricao("Entrega 101");
            e21.setNota(8.5);
            Entrega e22 = new Entrega();
            e22.setId(102L);
            ...
            Colaborador c3 = new Colaborador(m3, "Carla", LocalDate.of(2024, 3, 3), "Dev");
            AvaliacaoComportamento av3 = new AvaliacaoComportamento();
            ...
            ColaboradorRespostaDTO r1 = resultado.getFirst();
            ...
            ColaboradorRespostaDTO r2 = resultado.get(1);
            ...
            ColaboradorRespostaDTO r3 = resultado.get(2);
    ...
    @Nested
    class atualizaColaboradorPorMatricula {

        @Test
        @DisplayName("Deve atualizar nome e cargo quando ambos forem informados")
        void deveAtualizarNomeECargo() {
            // Arrange
            UUID matricula = UUID.randomUUID();

            // Simula um colaborador encontrado e vindo do banco de dados
            var colaboradorExistente = new Colaborador(matricula, "Antigo Nome", LocalDate.of(2024,1,1), "Antigo Cargo");
        ...
        void deveAtualizarApenasNome() {
            ...
            // Simula um colaborador encontrado e vindo do banco de dados
            var colaboradorExistente = new Colaborador(matricula, "Nome Antigo", LocalDate.of(2024,2,2), "Cargo Mantido");

            // Configura o Mock para retornar um colaborador (ou vazio) ao executar o método findById()
            when(colaboradorRepository.findById(matricula)).thenReturn(Optional.of(colaboradorExistente));

            // Cria o DTO simulando o input do usuário
            var dto = new AtualizaColaboradorDTO("Nome Atualizado", null);
        ...
        void deveAtualizarApenasCargo() {
            ...
            // Simula um colaborador encontrado e vindo do banco de dados
            var existente = new Colaborador(matricula, "Nome Mantido", LocalDate.of(2024,3,3), "Cargo Antigo");

            // Configura o Mock para retornar um colaborador (ou vazio) ao executar o método findById()
            when(colaboradorRepository.findById(matricula)).thenReturn(Optional.of(existente));

            // Cria o DTO simulando o input do usuário
            var dto = new AtualizaColaboradorDTO(null, "Cargo Atualizado");
        ...
        void deveManterDadosQuandoDtoNulo() {
            ...
            // Simula um colaborador encontrado e vindo do banco de dados
            var existente = new Colaborador(matricula, "Nome Original", LocalDate.of(2024,4,4), "Cargo Original");

            // Configura o Mock para retornar um colaborador (ou vazio) ao executar o método findById()
            when(colaboradorRepository.findById(matricula)).thenReturn(Optional.of(existente));

            // Cria o DTO simulando o input do usuário
            var dto = new AtualizaColaboradorDTO(null, null);
        ...
        void deveLancarResourceNotFoundQuandoMatriculaNaoExistir() {
            ...
            // Cria o DTO simulando o input do usuário
            var dto = new AtualizaColaboradorDTO("Qualquer", "Qualquer");
        ...
        void deveLancarIllegalArgumentExceptionQuandoUuidInvalido() {
            ...
            // Cria o DTO simulando o input do usuário
            var dto = new AtualizaColaboradorDTO("Nome", "Cargo");
    ...
    class calcularPerformanceFinal {
        ...
        void deveCalcularPerformanceFinalComSucesso() {
            ...
            var avaliacao = new AvaliacaoComportamento();
        ...
        void deveLancarNegocioExceptionQuandoMenosDeDuasEntregas() {
            ...
            var colaborador = new Colaborador(matricula, "Carol", LocalDate.of(2024,3,3), "Desenvolvedora");
