...
class EntregaServiceTest {
    ...
    class cadastrarEntregaColaborador {
        ...
        void deveCadastrarEntregaComSucesso() {
            ...
            colaborador.setEntregas(new ArrayList<>(List.of(new Entrega(), new Entrega(), new Entrega())));
            ...
            ArgumentCaptor<Entrega> entregaPassadaSave = ArgumentCaptor.forClass(Entrega.class);
            ...
            when(entregaRepository.save(any(Entrega.class))).thenReturn(salvo);

            // Act
            // Executa o método cadastrarEntregaColaborador() para, de fato, testá-lo
            Entrega retorno = entregaService.cadastrarEntregaColaborador(matricula.toString(), dto);
            ...
            Entrega capturada = entregaPassadaSave.getValue();
        ...
        void deveLancarResourceNotFoundQuandoColaboradorNaoExistir() {
            ...
            // Cria o DTO simulando o input do usuário
            var dto = new CadastroEntregaDTO("Doc", 3.0);
        ...
        void deveLancarNegocioQuandoLimiteUltrapassado() {
            ...
            colaborador.setEntregas(new ArrayList<>(List.of(new Entrega(), new Entrega(), new Entrega(), new Entrega())));

            when(colaboradorRepository.findById(matricula)).thenReturn(Optional.of(colaborador));

            var dto = new CadastroEntregaDTO("Nova", 4.0);
        ...
        void deveLancarIllegalArgumentExceptionQuandoUuidInvalido() {
            ...
            var dto = new CadastroEntregaDTO("Qualquer", 3.5);
    ...
    class consultarEntregaPorId {
        ...
        void deveConsultarEntregaComSucesso() {
            ...
            EntregaRepostaDTO dto = entregaService.consultarEntregaPorId(matricula.toString(), entregaId);
        ...
        void deveLancarResourceNotFoundQuandoEntregaNaoExistir() {
            ...
            UUID matricula = UUID.randomUUID();
            Long entregaId = 99L;
            var colaborador = new Colaborador(matricula, "Dan", LocalDate.of(2024,4,4), "Arq");
            when(colaboradorRepository.findById(matricula)).thenReturn(Optional.of(colaborador));
        ...
        void deveLancarNegocioQuandoEntregaNaoPertencer() {
            ...
            var colaborador = new Colaborador(matricula, "Eve", LocalDate.of(2024,5,5), "QA");
            var outroColab = new Colaborador(outro, "X", LocalDate.of(2024,1,1), "Y");
    ...
    class listarEntregasPorColaborador {
        ...
        void deveListarEntregas() {
            // Arrange
            UUID matricula = UUID.randomUUID();
            var colaborador = new Colaborador(matricula, "Fay", LocalDate.of(2024,6,6), "PM");

            var e1 = new Entrega(); e1.setId(1L); e1.setDescricao("E1"); e1.setNota(3.0); e1.setColaborador(colaborador);
            var e2 = new Entrega(); e2.setId(2L); e2.setDescricao("E2"); e2.setNota(4.0); e2.setColaborador(colaborador);
            ...
            List<EntregaRepostaDTO> lista = entregaService.listarEntregasPorColaborador(matricula.toString());
    ...
    class deletarEntregaColaborador {
        ...
        void deveDeletarEntregaComSucesso() {
            ...
            var colaborador = new Colaborador(matricula, "Gus", LocalDate.of(2024,7,7), "Dev Sr.");
            var entrega = new Entrega();
            entrega.setId(entregaId);
            entrega.setColaborador(colaborador);
        ...
        void deveLancarResourceNotFoundQuandoEntregaNaoExistir() {
            ...
            UUID matricula = UUID.randomUUID();
            Long entregaId = 123L;
            var colaborador = new Colaborador(matricula, "Hil", LocalDate.of(2024,8,8), "PO");
            when(colaboradorRepository.findById(matricula)).thenReturn(Optional.of(colaborador));
            when(entregaRepository.findById(entregaId)).thenReturn(Optional.empty());
        ...
        void deveLancarNegocioQuandoEntregaNaoPertencerAoColaborador() {
            ...
            var colaborador = new Colaborador(matricula, "Ian", LocalDate.of(2024,9,9), "QA");
            var outroColab = new Colaborador(outro, "X", LocalDate.of(2024,1,1), "Y");
    ...
    class atualizarEntregaPorId {
        ...
        void deveAtualizarDescricaoENota() {
            ...
            var colaborador = new Colaborador(matricula, "Jade", LocalDate.of(2024,10,10), "Arq");
            var entrega = new Entrega(); entrega.setId(entregaId); entrega.setDescricao("Antiga"); entrega.setNota(3.0); entrega.setColaborador(colaborador);
            ...
            // Cria o DTO simulando o input do usuário
            var dto = new AtualizaEntregaDTO("Nova Desc", 4.5);
            ...
            // Verifica alterações
            Entrega salvo = entregaPassadaSave.getValue();
        ...
        void deveAtualizarApenasDescricao() {
            ...
            var colaborador = new Colaborador(matricula, "Kai", LocalDate.of(2024,11,11), "Eng");
            var entrega = new Entrega(); entrega.setId(entregaId); entrega.setDescricao("Antiga"); entrega.setNota(2.0); entrega.setColaborador(colaborador);

            when(colaboradorRepository.findById(matricula)).thenReturn(Optional.of(colaborador));
            when(entregaRepository.findById(entregaId)).thenReturn(Optional.of(entrega));

            var dto = new AtualizaEntregaDTO("Desc Atualizada", null);
        ...
        void deveAtualizarApenasNota() {
            ...
            var colaborador = new Colaborador(matricula, "Lia", LocalDate.of(2024,12,12), "Dev");
            var entrega = new Entrega(); entrega.setId(entregaId); entrega.setDescricao("Keep"); entrega.setNota(1.5); entrega.setColaborador(colaborador);

            when(colaboradorRepository.findById(matricula)).thenReturn(Optional.of(colaborador));
            when(entregaRepository.findById(entregaId)).thenReturn(Optional.of(entrega));

            var dto = new AtualizaEntregaDTO(null, 4.0);
        ...
        void deveLancarRuntimeQuandoColaboradorNaoExistir() {
            ...
            RuntimeException ex = assertThrows(
                    ...
                    () -> entregaService.atualizarEntregaPorId(matricula.toString(), 1L, new AtualizaEntregaDTO("x", 2.0))
            );
        ...
        void deveLancarRuntimeQuandoEntregaNaoExistir() {
            // Arrange
            UUID matricula = UUID.randomUUID();
            var colaborador = new Colaborador(matricula, "Meg", LocalDate.of(2024,10,1), "Líder");
            when(colaboradorRepository.findById(matricula)).thenReturn(Optional.of(colaborador));
            ...
            RuntimeException ex = assertThrows(
                    RuntimeException.class,
                    () -> entregaService.atualizarEntregaPorId(matricula.toString(), 9L, new AtualizaEntregaDTO("x", 2.0))
            );
        ...
        void deveLancarRuntimeQuandoEntregaDeOutroColaborador() {
            ...
            var colaborador = new Colaborador(matricula, "Neo", LocalDate.of(2024,9,9), "SE");
            var outroColab = new Colaborador(outro, "Trin", LocalDate.of(2024,9,1), "SE");

            var entrega = new Entrega(); entrega.setId(entregaId); entrega.setColaborador(outroColab);
            ...
            RuntimeException ex = assertThrows(
                    RuntimeException.class,
                    () -> entregaService.atualizarEntregaPorId(matricula.toString(), entregaId, new AtualizaEntregaDTO("x", 2.0))
            );
            assertTrue(ex.getMessage().contains("Acesso negado"));
        ...
        void deveLancarIllegalArgumentExceptionQuandoUuidInvalido() {
            ...
            assertThrows(
                    IllegalArgumentException.class,
                    () -> entregaService.atualizarEntregaPorId(uuidInvalido, 1L, new AtualizaEntregaDTO("x", 2.0))
            );
