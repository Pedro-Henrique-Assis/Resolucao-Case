...
class AvaliacaoComportamentoServiceTest {
    ...
    class cadastrarAvaliacaoComportamental {
        ...
        void deveCadastrarAvaliacaoParaColaboradorExistente() {
            ...
            ArgumentCaptor<AvaliacaoComportamentoEntity> avaliacaoPassadaSave = ArgumentCaptor.forClass(AvaliacaoComportamentoEntity.class);

            // Configura o Mock para retornar a avaliação com ID após salvar
            var salvo = new AvaliacaoComportamentoEntity(10L, 5.0, 4.0, 3.0, 5.0);
            salvo.setColaborador(colaborador);
            when(avaliacaoComportamentoRepository.save(any(AvaliacaoComportamentoEntity.class))).thenReturn(salvo);
            ...
            AvaliacaoComportamentoEntity capturado = avaliacaoPassadaSave.getValue();
    ...
    class consultaAvaliacaoPorMatricula {
        ...
        void deveRetornarAvaliacaoComMediaCalculada() {
            ...
            var avaliacao = new AvaliacaoComportamentoEntity(100L, 5.0, 4.0, 3.0, 5.0);
            ...
            AvaliacaoComportamentoResponse resposta = avaliacaoService.consultaAvaliacaoPorMatricula(matricula.toString());
            ...
            assertEquals(5.0, resposta.notaAvaliacaoComportamental());
            assertEquals(4.0, resposta.notaAprendizado());
            assertEquals(3.0, resposta.notaTomadaDecisao());
            assertEquals(5.0, resposta.notaAutonomia());
            assertEquals(mediaEsperada, resposta.mediaNotas());
        }
    ...
    class atualizaAvaliacaoPorMarticula {
        ...
        void deveAtualizarTodasAsNotas() {
            ...
            // Simula um colaborador encontrado e vindo do banco de dados
            var colaborador = new ColaboradorEntity(matricula, "Dan", LocalDate.of(2024,4,4), "Arquiteto");

            // Cria uma avaliação existente associada ao colaborador
            var avaliacao = new AvaliacaoComportamentoEntity(200L, 2.0, 2.0, 2.0, 2.0);
            avaliacao.setColaborador(colaborador);
            colaborador.setAvaliacaoComportamento(avaliacao);
            ...
            // Cria o DTO simulando o input do usuário
            var dto = new AvaliacaoComportamentoAtualizaRequest(5.0, 4.0, 3.0, 5.0);
            ...
            AvaliacaoComportamentoEntity salvo = avaliacaoPassadaSave.getValue();
        ...
        void deveAtualizarParcialmenteAsNotas() {
            ...
            // Simula um colaborador encontrado e vindo do banco de dados
            var colaborador = new ColaboradorEntity(matricula, "Eva", LocalDate.of(2024,5,5), "Analista Sr.");

            // Cria uma avaliação existente associada ao colaborador
            var avaliacao = new AvaliacaoComportamentoEntity(300L, 2.0, 3.0, 4.0, 1.0);
            avaliacao.setColaborador(colaborador);
            colaborador.setAvaliacaoComportamento(avaliacao);
            ...
            var dto = new AvaliacaoComportamentoAtualizaRequest(null, 5.0, null, 4.5);
        ...
        void deveLancarNegocioExceptionQuandoSemAvaliacaoParaAtualizar() {
            ...
            var colaborador = new ColaboradorEntity(matricula, "Fred", LocalDate.of(2024,6,6), "Designer");
            colaborador.setAvaliacaoComportamento(null);
    ...
    class deletarAvaliacoesPorMatricula {
        ...
        void deveRemoverAvaliacaoQuandoExistir() {
            ...
            var colaborador = new ColaboradorEntity(matricula, "Gina", LocalDate.of(2024,7,7), "PO");
            var avaliacao = new AvaliacaoComportamentoEntity(500L, 5.0, 5.0, 5.0, 5.0);
            avaliacao.setColaborador(colaborador);
            colaborador.setAvaliacaoComportamento(avaliacao);
        ...
        void naoDeveSalvarQuandoSemAvaliacao() {
            ...
            // Simula um colaborador encontrado sem avaliação
            var colaborador = new ColaboradorEntity(matricula, "Heitor", LocalDate.of(2024,8,8), "DevOps");
            colaborador.setAvaliacaoComportamento(null);
